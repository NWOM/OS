...
int main() {
    ...
    struct Process processes[] = {
        {1, 0, 5, 0},  // Process ID, Arrival Time, Service Time, Completion Time, Turnaround Time, Waiting Time (initialized as 0)
        {2, 0, 3, 0},  // Modify this array to add more processes
        {3, 0, 8, 0},
        {4, 0, 6, 0},
        {5, 0, 2, 0}
    };
